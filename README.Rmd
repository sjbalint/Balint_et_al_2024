...
<h3>/scripts</h3> R scripts that tidy the raw data, generate figures, and perform stats
<h3>/Rdata</h3> .rds and .Rdata files of tidied data
<h3>/export</h3> .csv files of raw and tidied data in several different layouts for readability
